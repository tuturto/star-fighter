...
let menuRenderer (state:Mob option) res time =
    Option.iter (fun (menu:Mob) ->
                    ...
                    res.spriteBatch.DrawString(font12, "press button to start", Vector2(375.0f, 450.0f), Color.White)) state
